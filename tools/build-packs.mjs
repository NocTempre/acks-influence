 ...
 */
function reactionEffect(itemId, { id, name, value, situational = true, tone = "all", label }) {
  return {
    _id: id,
...
const PROFICIENCIES = [
  ...
  { id: "acksInflMystcAur", name: "Mystic Aura", description: "The character projects his magical power to cause awe. He gains a +1 bonus to reaction rolls to impress and intimidate. If this bonus brings the total to 12 or more, the subjects act as if bewitched while in his presence." },
  {
    ...
    effect: { id: "acksInflEffBeast", name: "Beast Friendship (reaction)", value: 2, situational: true, tone: "all", label: "Beast Friendship — target is a normal animal (+2)" },
  },
  {
    id: "acksInflAnimHusb",
    ...
    effect: { id: "acksInflEffAnimH", name: "Animal Husbandry (reaction)", value: 1, situational: true, tone: "all", label: "Animal Husbandry — tame, uncontrolled animal (+1)" },
  },
  {
    id: "acksInflFolkways",
    name: "Folkways",
    ...
    effect: { id: "acksInflEffFolkw", name: "Folkways (reaction)", value: 1, situational: true, tone: "all", label: "Folkways — 0th-level target in home settlement (+1)" },
  },
