...
const PROFICIENCIES = [
  ...
  { id: "acksInflBeastFrn", name: "Beast Friendship", description: "The character is well-schooled in the natural world and understands beasts. He gains +2 to all reaction rolls when encountering normal animals and can take animals as henchmen." },
  { id: "acksInflAnimHusb", name: "Animal Husbandry", description: "The character can care for and train animals. As an animal trainer he gains a +1 bonus to reaction rolls when approaching tame but uncontrolled animals of any type he can train." },
  { id: "acksInflFolkways", name: "Folkways", description: "The character knows the customs of a particular urban settlement. He gains a +1 bonus to reaction rolls with 0th-level characters he encounters in his settlement. (Revised Rules proficiency, provided here for testing.)" },
